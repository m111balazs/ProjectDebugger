...
set SRC_FILES=src\main.c src\core\engine.c src\core\input.c src\graphics\texture.c src\graphics\animation.c src\game\tilemap.c src\game\collision.c src\game\camera.c src\game\utils.c
